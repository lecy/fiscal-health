...
core2$pred_profitmargin[ core2$pred_profitmargin < x.01 ] <- x.01
core2$pred_profitmargin[ core2$pred_profitmargin > x.99 ] <- x.99
```
...
core2 %>%
  mutate( # pred_profitmargin = pred_profitmargin * 10000,
  ...
  stargazer( type = s.type, 
             ...
             summary.stat = c("min","p25","median",
                              "mean","p75","max", "sd"),
             covariate.labels = c("Pre-Depreciation Profitability Margin", "Age", 
