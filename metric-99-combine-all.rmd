...
pc4 <- principal( dd, nfactors=4, rotate = "varimax", scores = TRUE )
...
```{r}
fa3 <- fa( dd, nfactors = 3, rotate = "varimax", scores="regression"  )
fa4 <- fa( dd, nfactors = 4, rotate = "varimax", scores="regression" )

# fa3 <- fa( dd, nfactors = 3, fm="wls", scores="regression" )
print.psych( fa3, cut = 0.3 ) 
print.psych( fa4, cut = 0.3 ) 
```
