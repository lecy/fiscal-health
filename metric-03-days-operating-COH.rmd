...
mean( core2$daysoperating_coh > 365, na.rm=T ) 
core2$daysoperating_coh[ core2$daysoperating_coh > 365 ] <- 365
```
...
saveRDS( core.daysoperating_coh, "03-data-ratios/m-02-current-ratio.rds" )
write.csv( core.daysoperating_coh, "03-data-ratios/m-02-current-ratio.csv" )
```
