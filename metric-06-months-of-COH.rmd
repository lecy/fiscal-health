...
<br>
**Denominator:** ((Operating expenses – bad debts – depreciation) / 12)
...
# TEMPORARY VARIABLES 
operating_cash  <- ( core$nonintcashend + core$svngstempinvend + core$pldgegrntrcvblend + core$accntsrcvblend)
payables <- ( core$accntspayableend + core$grntspayableend )/12
...
## Months of Cash on Hand Density 
...
## Months of Cash on Hand by NTEE Major Code
...
## Months of Cash on Hand by Region 
...
## Months of Cash on Hand by Nonprofit Size (Expenses)
...
## Months of Cash on Hand by Nonprofit Size (Revenue)
...
## Months of Cash on Hand by Nonprofit Size (Net Assets)
...
## Months of Cash on Hand by Nonprofit Age
...
## Months of Cash on Hand by Land and Building Value
