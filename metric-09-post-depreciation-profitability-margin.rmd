---
title: "Metric 09 - Post-depreciation Profitability Margin"
author: ""
date: "April 8, 2022"
font: Lato
output:
...
variable.label <- "Post-Depreciation Profitability Margin"
...
# summary( core$postd_profitmargin )
```
...
core2$postd_profitmargin[ core2$postd_profitmargin > x.95 ] <- x.95
```
...
core2 %>%
  ...
  stargazer( type = s.type, 
             ...
             summary.stat = c("min","p25","median",
                              "mean","p75","max", "sd"),
             covariate.labels = c("Post-Depreciation Profitability Margin", "Age", 
...
## Post-Depreciation Profitability Margin Density 
...
## Post-Depreciation Profitability Margin by Nonprofit Size (Revenue)
